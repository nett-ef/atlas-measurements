...
def test_create_measurements(requests_mock, payload, mid):
    api_url = 'mock://atlas.ripe.net/api/v2/measurements'
    headers = {'Authorization': f'Key 11111111-2222-3333-4444-555555555555'}
...
def test_reduce_url(measurement, mid):
    msm_url = 'mock://atlas.ripe.net/measurements'
